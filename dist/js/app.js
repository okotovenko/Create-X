(() => {
    ...
    function initSliders() {
        if (document.querySelector(".top-team__slider.swiper")) new core(".top-team__slider.swiper", {
        ...
        if (document.querySelector(".bottom-team__slider.swiper")) new core(".bottom-team__slider.swiper", {
        ...
        if (document.querySelector(".check__slider.swiper")) new core(".check__slider.swiper", {
            modules: [ Navigation, Autoplay ],
            slidesPerView: 2,
            slidesPerColumn: 1,
            speed: 800,
        ...
        if (document.querySelector(".interested__slider.swiper")) new core(".interested__slider.swiper", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerColumn: 1,
        ...
        if (document.querySelector(".blogs__slider.swiper")) new core(".blogs__slider.swiper", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerColumn: 1,
    ...
    function ChangeList() {
        if (document.querySelector("#lectures-items")) {
            ...
            iconList.addEventListener("click", (function() {
                ...
                for (let i = 0; i < lecturesItem.length; i++) lecturesItem[i].classList.remove("active");
            }));
            iconTile.addEventListener("click", (function() {
                ...
                for (let i = 0; i < lecturesItem.length; i++) lecturesItem[i].classList.add("active");
            }));
        }
    }
    function playVideo() {
    ...
    if (document.querySelector("[data-timer-days]")) {
        ...
        const deadline1 = new Date(Date.now() + 60 * 1e3 * 60 * (24 * 7));
        ...
        modules_flsModules.CountdownTimer = new CountdownTimer({});
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
